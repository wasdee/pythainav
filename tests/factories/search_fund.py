...
#     regis_id = factory.Sequence(
#         lambda n: "{:0>3}_25{:0>2}".format(n, n) if n % 5 == 0 else "-"
#     )
#     regis_date = factory.Sequence(
#         lambda n: "2020-01-{:0>2}".format(n + 1) if n % 5 == 0 else "-"
#     )
#     cancel_date = factory.Sequence(
#         lambda n: "2020-01-{:0>2}".format(n + 1) if n % 5 == 0 else "-"
#     )
